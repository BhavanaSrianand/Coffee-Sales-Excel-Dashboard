...
2. Missing Data: Fill up data in the missing columns
...
1. Data Base Creation
   =
 The project starts by creating a database on the "Coffee Orders" {Reference sheet: Orders}. This is done by integrating data from the customers as well as the product's sheet where we get data on the customer details and product purchases.

<img width="1502" height="631" alt="image" src="https://github.com/user-attachments/assets/acc69637-0516-4512-85db-ca3e7e4f2097" />

2. Missing Data
   =

 Fill for the missing data columns in the orders sheet using X Lookup, Index, and Match Functions  
 =
Customer's Name, Email ID, and Country columns are filled using X lookup. {Reference sheet in the excel: Customers}
...
3. Data Analysis
   =
Generate 3 pivot tables to evaluate
=
-Sum of Total Sales of different coffee types over 3 years
=
...
=
<img width="275" height="109" alt="image" src="https://github.com/user-attachments/assets/e1a359ac-e041-4d5a-b663-1d963aef8104" />

-Top 5 Customers
=
<img width="302" height="168" alt="image" src="https://github.com/user-attachments/assets/ac08998b-8e63-4981-a63d-6f4bfd9e5de1" />

4.Data Visualisation
=
Create a line graph of the sum of total sales over time. Attach a timeframe to this graph. Customise the visual as per your creativity as keep the theme purple.
=
...
=
<img width="890" height="257" alt="image" src="https://github.com/user-attachments/assets/938548db-335e-46ca-ae70-e2997d7fc3d6" />
...
5. Dashboard Creation
   =
Organise all the visuals generated and design the "Coffee Sales Dashboard". Also, interlink the slicers to the other graphs created
<img width="1198" height="580" alt="image" src="https://github.com/user-attachments/assets/2d62eead-f9d6-41f6-8479-987b33f09386" />

6. Project Uses
   =
-To analyse segment wise sales at different points of time
-Draw inferences from the entire data as well as from the segment wise representation and make parallels
...
Thank you very much for visiting my page. Looking forward to connect!
